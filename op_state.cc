...
const char* op_state_c::register_name(uint register_code){
    ...
    case RegTypes::REG_NUL: return "NUL";
    case RegTypes::REG_EAX: return "EAX";
    case RegTypes::REG_ECX: return "ECX";
    case RegTypes::REG_EDX: return "EDX";
    case RegTypes::REG_EBX: return "EBX";
    case RegTypes::REG_ESP: return "ESP";
    case RegTypes::REG_EBP: return "EBP";
    case RegTypes::REG_ESI: return "ESI";
    case RegTypes::REG_EDI: return "EDI";
        //segment registers
    case RegTypes::REG_ES : return "ES";
    case RegTypes::REG_CS : return "CS";
    case RegTypes::REG_SS : return "SS";
    case RegTypes::REG_DS : return "DS";
    case RegTypes::REG_FS : return "FS";
    case RegTypes::REG_GS : return "GS";
        //control registers
    case RegTypes::REG_CR0: return "CR0";
    case RegTypes::REG_CR1: return "CR1";
    case RegTypes::REG_CR2: return "CR2";
    case RegTypes::REG_CR3: return "CR3";
    case RegTypes::REG_CR4: return "CR4";
        //FP registers
    case RegTypes::REG_MM0: return "MM0";
    case RegTypes::REG_MM1: return "MM1";
    case RegTypes::REG_MM2: return "MM2";
    case RegTypes::REG_MM3: return "MM3";
    case RegTypes::REG_MM4: return "MM4";
    case RegTypes::REG_MM5: return "MM5";
    case RegTypes::REG_MM6: return "MM6";
    case RegTypes::REG_MM7: return "MM7";
        //SSE registers
    case RegTypes::REG_XMM0: return "XMM0";
    case RegTypes::REG_XMM1: return "XMM1";
    case RegTypes::REG_XMM2: return "XMM2";
    case RegTypes::REG_XMM3: return "XMM3";
    case RegTypes::REG_XMM4: return "XMM4";
    case RegTypes::REG_XMM5: return "XMM5";
    case RegTypes::REG_XMM6: return "XMM6";
    case RegTypes::REG_XMM7: return "XMM7";
    default:
